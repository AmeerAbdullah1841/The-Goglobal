...
export default function APanelAnnouncementsPage() {
    ...
    const getTemplates = async () => {
        const q = query(collection(db, "announcements"), limit(10 * page));
                            ...
                            <form>
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <Input type="text" id="title" placeholder="Subject" value={subject} onChange={(e) => setSubject(e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="description">Announcement</Label>
                                        <Input type="email" id="description" placeholder="Announcement" value={message} onChange={(e) => setMessage(e.target.value)} />
                                    </div>
