...
export default function APanelpackage1sPage() {
    ...
    const package1s: package1[] = [
        ...
        },
        {
            ...
            title: "package 7",
            country: "Bhutan",
            categories: ["Category 10", "Category 11"],
            status: "Active",
            featured: "Top Rated",
            image: "https://via.placeholder.com/150"
        },
        ...
        },
        {
            ...
            title: "package 9",
            country: "China",
            categories: ["Category 13", "Category 14"],
            status: "Active",
            featured: "Top Rated",
            image: "https://via.placeholder.com/150"
        }
            ...
            <div className="w-full">
                ...
                <div className="w-full">
                    <div className="rounder-md">
                        <div className="h-[70vh] overflow-auto relative mb-2 no-scrollbar">
                <Table
                >
                    <TableHeader
                        ...
                        {package1s.slice(startindex, endindex).map((package1, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell className="flex items-center justify-center">
                                    <img src={package1.image} alt={package1.code} className="w-full h-full object-cover" />
                                </TableCell>
                                ...
                                <TableCell className="align-middle text-center space-x-2">
                                    <Link href={`/apanel/packages/edit/${package1.code}`}>
