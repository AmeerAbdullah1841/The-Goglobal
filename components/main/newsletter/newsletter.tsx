    ...
    return (
        <div className="flex items-center justify-center w-full p-16 bg-[#CECECE] space-x-14">
            <div className="flex flex-col items-center justify-center w-1/2">
                <h1 className="text-4xl font-bold">Subscribe to our <span className="text-[#B31F24]">Newsletter</span></h1>
            ...
            <div className="flex items-center justify-center w-1/2">
                ...
                <button className="p-2 bg-[#B31F24] text-white">Subscribe</button>
            </div>
        </div>
    );
}